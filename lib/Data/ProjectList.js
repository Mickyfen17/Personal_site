const Projects = [
  ...
  {
    title: 'Linked List',
    description: 'An application written in Vanilla JavaScript that allows users to bookmark favorite websites. Utilizing localStorage, the bookmarks persist after page refresh.',
