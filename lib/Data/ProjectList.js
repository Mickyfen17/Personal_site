const Projects = [
  ...
  {
    title: '2DoBox',
    description: 'Fully accessible single page application using Local Storage to keep track of To-Do\'s. In built functionality to sort by importance, mark To-Do as complete and delete as necessary. Application tested using Mocha, Chai and Selenium.',
  ...
  {
    title: 'Personal Site',
    description: 'My own Personal site built with React',
    image: '../../css/images/personal_site.png',
    gitHubRepo: 'https://github.com/Mickyfen17/Personal_site',
    siteURL: '#',
    techUsed: ['Javascript', 'React', 'HTML5', 'SCSS'],
  },
];
