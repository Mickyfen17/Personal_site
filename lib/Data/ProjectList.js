const Projects = [
  ...
  },
  {
    ...
    image: 'images/flexbox_sandbox.png',
  ...
  },
  {
    ...
    image: 'images/movie_tracker.png',
  ...
  },
  {
    title: 'Weathrly',
    description:
      'Mobile weather application built in React JS and tested with Mocha and Enzyme. It utilizes Weather Underground’s API to render on demand weather forecasts to a stylish and accessible user interface that supports an auto-complete location search.',
  ...
  },
  {
    title: 'GameTime',
    description:
      'Desktop replica of the classic arcade game Breakout built using vanilla JavaScript, HTML canvas and Mocha/Chai for testing. The game supports 5 levels of play.',
  ...
  },
  {
    title: 'SwapiBox',
    description:
      'A Star Wars game card  application where card data elements are pulled in using asynchronous promise calls and rendered using React. Users can also flag and retrieve favorites.',
